...
#include "CityHash.h"
#include "SSString/SSStringW.h"
#include "SSString/StringUtilityFunctions.h"
using namespace SS;
...
const SHasherW SHasherW::Empty = SHasherW(HASHER_EMPTY);
...
{
	return this->GetDirectValue() == Empty.GetDirectValue();
}
